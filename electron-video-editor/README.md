...
#### Project Presets (Platform Sizes)
- When creating a new project, choose platform sizes for YouTube, Instagram, Facebook, and TikTok.
- Presets include common resolutions: 4K/1080p/720p (YouTube), 1080x1920 vertical and 1080x1080 square (Instagram/Facebook), and 1080x1920 vertical (TikTok).
- The selected preset sets default export resolution/fps/bitrate; you can still override via the export dropdown.
