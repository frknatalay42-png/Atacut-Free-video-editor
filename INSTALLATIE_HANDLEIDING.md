...
A: De huidige setup is Windows-geoptimaliseerd. Mac/Linux ondersteuning vereist aanpassingen.

**V: Hoe voeg ik mijn eigen video-effecten toe?**
A: Zie `/src/renderer/components/` voor voorbeelden. React componenten kunnen gemakkelijk uitgebreid worden.
